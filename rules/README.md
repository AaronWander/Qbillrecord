...
```sh
cd /Users/aaron/Documents/augment-projects/persenal/jizhang
...
```sh
python3 scripts/export_imessage_sender.py --sender 95588 --out exports/95588_all.jsonl --limit 100
```
